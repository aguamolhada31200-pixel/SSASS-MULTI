...
const SEED: Profile[] = [
  ...
  },
  {
    ...
    tagline: "Compra e revenda no Grande Porto",
    bio: "Especialista em compra e revenda de prédios no centro histórico do Porto. 4 projetos concluídos com retorno médio acima de 20%. Procuro parceiros de capital para escalar.",
    city: "Porto",
    isVerified: true,
    ...
    interesses: ["Compra e Revenda", "Flip", "Centro histórico", "Porto"],
  ...
  },
  {
    ...
    interesses: ["Compra e Revenda", "Minho"],
  ...
  // Sócios de co-gestão de obras (parceiros nos projetos #001 e #003)
  {
    ...
    tagline: "Gestor de obra e parcerias de compra e revenda",
    ...
    interesses: ["Compra e Revenda", "Gestão de obra", "Porto"],
